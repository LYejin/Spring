...
<%-- 			
			...
			1. 회원가입시 모든 회원은 default ROLSE_USER 권한
			-->
			<se:authorize access="!hasRole('ROLE_USER')"> <!-- 인증되지 않았다면, 로그인하지 않았다면 -->
				<li><a href="${pageContext.request.contextPath}/joinus/login.htm">로그인</a></li>
			</se:authorize>
			...
			<se:authorize access="hasAnyRole('ROLE_USER','ROLE_ADMIN')"> <!-- 또는 or -->
