			...
			<div class="container" role="main">
				...
				<form name="form" id="form" role="form" method="post" enctype="multipart/form-data">
					<div class="mb-3">
						...
						<input type="file" id="file" name="file" class="fileName"
							accept="image/*">
               ...
               <label for="reg_id">사원 사진</label> <input type="file"
                  ...
                  <img src="upload/${param.filename}">
					...
					<div>
						...
						<!-- <button type="button" class="btn btn-sm btn-primary" id="btnSave">저장</button>  -->
						<input id="submit" class="btn btn-sm btn-primary" value="저장">
...
<script>
	(function($) {
		...
		$('#submit').click(function() {
			const dataInsert = {empno:$("#empno").val(),ename:$("#ename").val(),job:$("#selectBox").val(),mgr:$("#mgr").val(),hiredate:$("#datepicker").val(),sal:$("#sal").val(),comm:$("#comm").val(),deptno:$("#selectBox2").val(),filename:$("#file").val()};
			$.ajax({
				url : "emp/empInsert",
				type : 'POST',
				dataType : "json",
