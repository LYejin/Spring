   ...
   <div id="right-panel" class="right-panel">
								...
								<c:forEach var="list2" items="${list}">
									<tr onmouseover="this.style.backgroundColor='gray'"
										...
										<td align="center"><a
											...
											class="btn btn-sm btn-primary">수정</a> <a type="button" id="deleteButton" data-delete="${list2.empno}" class="btn btn-sm btn-warning">삭제</a></td>
									</tr>
								</c:forEach>
							</tbody>
      ...
      <div class="d-flex justify-content-between">
		...
		<br>
          <table>
          	<tr>
          		<td><input type="text" class="form-control" name="empno" placeholder="사원번호"></td>
          		<td><input type="text" class="form-control" name="ename" placeholder="이름"></td>
          		<td><input type="text" class="form-control" name="job" placeholder="직급"></td>
          		<td><input type="text" class="form-control" name="deptno" placeholder="부서번호"></td>
          		<td><input type="text" class="form-control" name="mgr" placeholder="MGR"></td>
          		<td><input type="text" class="form-control" name="mgr" placeholder="MGR"></td>
          	</tr>
          </table>
      <hr>
...
<script>
   ...
   $(document).ready(function() {
	   $('.btn-warning').on('click', function() {
			...
			$.ajax({
				url : "emp/empDelete/" + $(this).data('delete'),
				type : 'DELETE',
				success : function(data) {
					console.log("empdelete : " + data);
					location.reload();
				},
