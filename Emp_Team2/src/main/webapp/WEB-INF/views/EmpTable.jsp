							...
							<tbody>
								...
								<c:forEach var="list2" items="${list}">
									<tr onmouseover="this.style.backgroundColor='gray'"
										onmouseout="this.style.backgroundColor='white'">
										<td align="center"><img
											src="resources/upload/${list2.filename}"
											style="width: 30px; heigfht: 30px;"></td>
										<td align="center">${list2.empno}</td>
										<!-- 
										<td align="center"><img
											src="resources/upload/user.svg"
											style="width: 30px; heigfht: 30px;"></td>
										<td align="center">${list2.empno}</td>
										 -->
										<td align="center">
										...
										<td align="center"><a
											...
											class="btn btn-sm btn-warning">삭제</a></td>
											 --> 
											<a href="#" data-empno="${list2.empno}" class="btn btn-sm btn-warning delete-button">삭제</a>
									</tr>
								</c:forEach>
							</tbody>
                  ...
                  $.ajax({
                     ...
                     success : function(data) {
                        ...
                        /* 	<td id="e" align="center"><img
                           ...
                           let startable = $("#tbody");
                              startable += "<tr>";
                              	 startable += "<td>" + "<img src=\"resources/upload/"  + value.filename +  
