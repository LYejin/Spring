				...
				<div id="content">
					...
					<div id="notice-article-detail" class="article-detail margin-large" >						
						...
						<dl class="article-detail-row">
							...
							<dd class="article-detail-data">
								<a href="">${noticeDetailData.fileSrc}</a>
							</dd>
						</dl>
					...
					<p class="article-comment margin-small">
						...
						<a class="btn-edit button" href="noticeEdit.do?seq=${noticeDetailData.seq}">수정</a>
						<a class="btn-del button" href="noticeDel.do?seq=${noticeDetailData.seq}">삭제</a>
					</p>
